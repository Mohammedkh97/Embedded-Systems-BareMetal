...
C_SRCS += \
../Private/Delay/delay.c 

C_DEPS += \
./Private/Delay/delay.d 

OBJS += \
./Private/Delay/delay.o 


# Each subdirectory must supply rules for building sources it contributes
Private/Delay/%.o Private/Delay/%.su Private/Delay/%.cyclo: ../Private/Delay/%.c Private/Delay/subdir.mk
...
clean: clean-Private-2f-Delay

clean-Private-2f-Delay:
	-$(RM) ./Private/Delay/delay.cyclo ./Private/Delay/delay.d ./Private/Delay/delay.o ./Private/Delay/delay.su

.PHONY: clean-Private-2f-Delay
