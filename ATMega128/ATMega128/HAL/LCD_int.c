...
void LCD_Init(void)
{
	write_instruction(0x02); // Initialize LCD in 4-bit mode
	write_instruction(0x28); // 2 lines, 5x8 matrix
	write_instruction(0x0C); // Display on, cursor off
	write_instruction(0x06); // Increment cursor
